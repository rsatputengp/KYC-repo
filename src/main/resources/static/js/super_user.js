...
//            Branch Access permission *_*
         ...
         $scope.options = ["AHERI", "AKOLA", "AKOT", "AMGAON", "AMRAWATI", "ANJANGAON", "ARMORI", "ARNI", "ARVI",
             "ASHTI", "BALARSHAH", "BHADRAWATI", "BHANDARA", "BHIWAPUR", "BRHAMPURI", "BULDHANA", "CHAMORSHI",
             "CHANDRAPUR", "CHANDUR BAJAR", "CHANDUR RAILWAY", "CHIKHALI", "DARWAH", "DARYAPUR", "DEOLI", "DEORI",
             "DEULGAON", "DHANORA", "DIGRAS", "GADCHIROLI", "GANDHIBAGH", "GHATANJI", "GONDIA MAIN BRANCH", "GONDPIPARI", "GOREGAON",
             "HEAD OFFICE GONDIA", "HINGANGHAT", "HINGNA", "JALGAON JAMOD", "KALAMB", "KALMESHWAR", "KANHAN", "KARANJA GHADGE",
             "KARANJA LAD", "KATOL", "KHAMGAON", "KORCHI", "KUHI", "KURKHEDA", "LAKHANDUR", "LAKHANI", "LONAR", "MAHAGAON", "MALEGAON",
             "MALKAPUR", "MANGLURPIR", "MANISH NAGAR", "MANORA", "MAREGAON", "MAUDA", "MEHKAR", "MOHADI", "MORGAON ARJUNI",
             "MORSHI", "MUL", "MULCHERA", "MURTIJAPUR", "NAGBHID", "NAGPUR", "NAGPUR WEALTH", "NANDURA", "NARKHED",
             "NER PARSOPANT", "PANDHARKAWADA", "PARATWADA", "PARSHIVNI", "PATUR", "PAUNI", "PUSAD", "RAJURA", "RALEGAON",
             "RAMTEK", "RISOD", "SADAK ARJUNI", "SAHAYOGCHHATRAPATI ", "SAKOLI", "SALEKASA", "SAMUDRAPUR", "SANGRAMPUR", "SAOLI", "SAONER", "SELOO",
